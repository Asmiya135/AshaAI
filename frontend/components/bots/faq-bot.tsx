...
export function FaqBot({ onBack }: FaqBotProps) {
  const [messages, setMessages] = useState([
    {
      role: "bot",
      content:
        "Hello! I'm the FAQ Helper Bot. I can answer common questions about career development, job searching, and professional growth. What would you like to know?",
    },
  ])
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          role: "bot",
          content:
            "That's a great question! Here's what you should know:\n\nWhen preparing for a job interview, research the company thoroughly, practice common interview questions, prepare examples of your achievements, and have questions ready to ask the interviewer. It's also important to dress professionally and arrive early.\n\nWould you like more specific interview tips for your industry?",
        },
      ])
      setIsTyping(false)
    }, 1500)
    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center">
          <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center mr-3">
            <HelpCircle className="h-5 w-5 text-white" />
          </div>
          <h2 className="text-2xl font-bold">FAQ Helper Bot</h2>
        </div>
      </motion.div>
