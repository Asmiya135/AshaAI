...
export function JobBot({ onBack }: JobBotProps) {
  const [messages, setMessages] = useState([
    {
      role: "bot",
      content:
        "Hi there! I'm the Job Matcher Bot. I can help you find the perfect job opportunities based on your skills and preferences. What kind of job are you looking for?",
    },
  ])
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          role: "bot",
          content:
            "I've found several job opportunities that match your criteria. Would you like me to filter them by location, experience level, or salary range?",
        },
      ])
      setIsTyping(false)
    }, 1500)
    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center">
          ...
          <h2 className="text-2xl font-bold">Job Matcher Bot</h2>
        </div>
      </motion.div>
